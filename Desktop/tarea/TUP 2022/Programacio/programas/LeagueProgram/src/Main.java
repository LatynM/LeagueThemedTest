...
public class Main {
    public static void main(String[] args) {
        ...
        int opc=0,opcBuild=0,clas=0,reg=0,cost=0,num=0,claseMostrar=0,regMostrar=0,indice=0,i,precioObjeto=0;
        String name = null,quote=null,nombreObjeto=null;
            ...
            switch (opc){
                    ...
                    if(campeonesTotales.isEmpty())
                    {
                        ...
                        do{
                            ...
                            try{
                                ...
                                System.out.println(">ERROR NOMBRE OBJETO");
                            }

                            s.nextLine();

                            System.out.println("INGRESE PRECIO DE OBJETO");
                            try{
                                precioObjeto=s.nextInt();
                            }catch (Exception e){
                                System.out.println(">ERROR PRECIO OBJETO");
                            }

                            Item objetoNuevo = new Item(nombreObjeto,precioObjeto);

                            campeonesTotales.get(indice).agregarItem(objetoNuevo);
                ...
                case 7:
                    ...
                    if(campeonesTotales.isEmpty()){
                        ...
                        campeonesTotales.get(indice).mostrarBuild();
    ...
    private static void menu(){
        ...
        System.out.println("8- ORDENAR CAMPEONES POR PRECIO");
    }
}